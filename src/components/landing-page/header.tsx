...
const Header = () => {
  ...
  return (
    <header className="p-4 flex justify-center item-center">
      <Link href={"/"} className=" flex gap-2 mr-auto">
        <Image src={logo} alt="cypres logo" width={25} height={25} />
      ...
      <NavigationMenu className=" hidden md:block">
        <NavigationMenuList className="gap-6">
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-col-[.75fr_1fr]">
                ...
                <ListItem href="#" title="introduction">
                  Re-usable components builts using Radix Ui and tailwind Css
                </ListItem>
                <ListItem href="#" title="installation">
                  Hpw to Intall dependencies and structure your app
                </ListItem>
                <ListItem href="#" title="Typography">
                  Styles for heading, paragraphs, list...etc
                </ListItem>
              </ul>
            </NavigationMenuContent>
          </NavigationMenuItem>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4 md:grid-rows-2">
                <ListItem key={"Pro plan"} title="Pro Plan" href="#">
                  Unlock full power with collaborators
                </ListItem>
                <ListItem title="Pro Plan" href="#">
                  Great for theme just starting out
                </ListItem>
              </ul>
            </NavigationMenuContent>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                {component.map((com) => (
                  <ListItem key={com.title} title={com.title} href={com.href}>
                    {com.description}
                  </ListItem>
                ))}
              </ul>
